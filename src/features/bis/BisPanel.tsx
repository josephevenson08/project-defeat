    ...
    return (
      <Panel title="BiS / Ranked Gear" eyebrow="Guide list" className="bis-panel-shell">
        <div className="bis-empty" data-testid="bis-empty-state">
          ...
          <p>Shaman, Warrior, Paladin, Priest, and Druid have a Phase 2 starter ranked list for every spec so far. More classes plug into this same panel as they are audited.</p>
        </div>
      </Panel>
    )
  }
