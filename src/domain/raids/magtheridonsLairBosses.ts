...
export const magtheridonsLairBosses: readonly RaidBoss[] = [
  {
    ...
    loot: [
      ...
      { name: 'Eye of Magtheridon', dropType: 'Boss', roles: ['Caster DPS'], needsVerification: true, notes: 'Well-known caster trinket; real Magtheridon drop, not yet in the item catalog.' },
      { name: 'Karaborian Talisman', dropType: 'Boss', roles: ['Physical DPS'], needsVerification: true, notes: 'Real Magtheridon drop, not yet in the item catalog.' },
      { name: 'Thundering Greathelm', dropType: 'Boss', roles: ['Tank'], needsVerification: true, notes: 'Real Magtheridon drop, not yet in the item catalog.' },
      { name: 'Cloak of the Pit Stalker', dropType: 'Boss', roles: ['Physical DPS'], needsVerification: true, notes: 'Real Magtheridon drop, not yet in the item catalog.' },
      { name: "Liar's Tongue Gloves", dropType: 'Boss', roles: ['Physical DPS'], needsVerification: true, notes: 'Real Magtheridon drop, not yet in the item catalog.' },
      { name: 'Terror Pit Girdle', dropType: 'Boss', roles: ['Physical DPS'], needsVerification: true, notes: 'Real Magtheridon drop, not yet in the item catalog.' },
      { name: 'Girdle of the Endless Pit', dropType: 'Boss', roles: ['Tank'], needsVerification: true, notes: 'Real Magtheridon drop, not yet in the item catalog.' },
      { name: 'Crystalheart Pulse-Staff', dropType: 'Boss', roles: ['Healer'], needsVerification: true, notes: 'Real Magtheridon drop, not yet in the item catalog.' },
      { name: 'Glaive of the Pit', dropType: 'Boss', roles: ['Physical DPS'], needsVerification: true, notes: 'Real Magtheridon drop, not yet in the item catalog.' },
