...
export const gruulsLairBosses: readonly RaidBoss[] = [
  {
    ...
    loot: [
      ...
      { name: 'Pauldrons of the Fallen Champion', dropType: 'Tier Token', notes: 'T4 shoulder token — Paladin, Priest, Warlock.' },
      { name: 'Pauldrons of the Fallen Defender', dropType: 'Tier Token', notes: 'T4 shoulder token — Warrior, Priest, Druid.' },
      { name: 'Pauldrons of the Fallen Hero', dropType: 'Tier Token', notes: 'T4 shoulder token — Hunter, Mage, Rogue, Shaman.' },
      ...
      { name: 'Belt of Divine Inspiration', dropType: 'Boss', roles: ['Healer'], needsVerification: true, notes: 'Real Maulgar drop, not yet in the item catalog.' },
      { name: 'Malefic Mask of the Shadows', dropType: 'Boss', roles: ['Physical DPS'], needsVerification: true, notes: 'Real Maulgar drop, not yet in the item catalog.' },
      { name: "Maulgar's Warhelm", dropType: 'Boss', roles: ['Physical DPS'], needsVerification: true, notes: 'Real Maulgar drop, not yet in the item catalog.' },
      { name: 'Hammer of the Naaru', dropType: 'Boss', roles: ['Healer'], needsVerification: true, notes: 'Real Maulgar drop, not yet in the item catalog.' },
    ],
  },
  {
    ...
    loot: [
      ...
      { name: 'Leggings of the Fallen Champion', dropType: 'Tier Token', notes: 'T4 leg token — Paladin, Priest, Warlock.' },
      { name: 'Leggings of the Fallen Defender', dropType: 'Tier Token', notes: 'T4 leg token — Warrior, Priest, Druid.' },
      { name: 'Leggings of the Fallen Hero', dropType: 'Tier Token', notes: 'T4 leg token — Hunter, Mage, Rogue, Shaman.' },
      { name: 'Teeth of Gruul', dropType: 'Boss', roles: ['Physical DPS'], needsVerification: true, notes: 'Real Gruul drop, not yet in the item catalog.' },
      { name: 'Eye of Gruul', dropType: 'Boss', roles: ['Healer'], needsVerification: true, notes: 'Real Gruul drop, not yet in the item catalog.' },
      { name: 'Axe of the Gronn Lords', dropType: 'Boss', roles: ['Physical DPS'], needsVerification: true, notes: 'Real Gruul drop, not yet in the item catalog.' },
      { name: 'Bloodmaw Magus-Blade', dropType: 'Boss', roles: ['Caster DPS'], needsVerification: true, notes: 'Real Gruul drop, not yet in the item catalog.' },
      { name: "Collar of Cho'gall", dropType: 'Boss', roles: ['Caster DPS'], needsVerification: true, notes: 'Real Gruul drop, not yet in the item catalog.' },
      { name: "Cowl of Nature's Breath", dropType: 'Boss', roles: ['Caster DPS'], needsVerification: true, notes: 'Real Gruul drop, not yet in the item catalog.' },
      { name: 'Gauntlets of Martial Perfection', dropType: 'Boss', roles: ['Physical DPS'], needsVerification: true, notes: 'Real Gruul drop, not yet in the item catalog.' },
      { name: 'Gauntlets of the Dragonslayer', dropType: 'Boss', roles: ['Tank'], needsVerification: true, notes: 'Real Gruul drop, not yet in the item catalog.' },
      { name: 'Windshear Boots', dropType: 'Boss', roles: ['Physical DPS'], needsVerification: true, notes: 'Real Gruul drop, not yet in the item catalog.' },
      { name: 'Gronn-Stitched Girdle', dropType: 'Boss', roles: ['Physical DPS'], needsVerification: true, notes: 'Real Gruul drop, not yet in the item catalog.' },
    ],
  },
]
