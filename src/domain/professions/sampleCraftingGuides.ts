...
/**
 * Concise leveling-path guides for the 9 crafting/secondary professions. These are not
...
const alchemyLeveling: readonly RecipeLeveling[] = [
  ...
  {
    skillRange: [300, 315],
    recipeOrItem: "Pick one starter craft: Volatile Healing Potion, Adept's Elixir, or Onslaught Elixir (craft ~15x)",
    recipeSource: 'Master Alchemy trainer (Outland).',
    keyMaterials: ['Felweed', 'Crystal Vial'],
  },
  {
    skillRange: [315, 340],
    recipeOrItem: 'Continue with trainer potions/elixirs (e.g. Major Dreamless Sleep precursors, Elixir of Major Defense)',
    recipeSource: 'Master Alchemy trainer (Outland).',
    needsVerification: true,
  },
  {
    skillRange: [340, 355],
    recipeOrItem: 'Super Mana Potion',
    recipeSource: 'BoE recipe purchasable from Daga Ramba or Haalrun (Nagrand).',
    keyMaterials: ['Felweed', 'Mana Thistle', 'Crystal Vial'],
  },
  {
    skillRange: [355, 375],
    recipeOrItem: 'Major Dreamless Sleep Potion',
    recipeSource: 'BoE recipe purchasable from Daga Ramba or Leeli Longhaggle.',
  },
  {
    skillRange: [325, 375],
