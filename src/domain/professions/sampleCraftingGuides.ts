...
const leatherworkingLeveling: readonly RecipeLeveling[] = [
  ...
  {
    skillRange: [300, 325],
    recipeOrItem: '30x Knothide Armor Kit',
    recipeSource: 'Master Leatherworking trainer (Outland).',
    keyMaterials: ['120 Knothide Leather'],
    notes: 'Convert Knothide Leather Scraps to Knothide Leather first if you farmed them.',
  },
  {
    skillRange: [325, 335],
    recipeOrItem: '222x Heavy Knothide Leather',
    recipeSource: 'Pattern sold by Cro Threadstrong in Shattrath City.',
    keyMaterials: ['1,110 Knothide Leather'],
    notes: 'Limited-supply pattern, so it may need a wait. The output is the material for 350 and 365 — keep it.',
  },
  {
    skillRange: [335, 350],
    recipeOrItem: '20x Thick Draenic Vest',
    recipeSource: 'Master Leatherworking trainer (Outland).',
    keyMaterials: ['280 Knothide Leather', '60 Rune Thread'],
    notes: 'Yellow for the last ten points, so expect a few more than twenty.',
  },
  {
    skillRange: [350, 365],
    recipeOrItem: '50x Heavy Knothide Armor Kit',
    recipeSource: 'Master Leatherworking trainer (Outland).',
    keyMaterials: ['150 Heavy Knothide Leather'],
    notes: 'Green for the last five points; in practice this lands anywhere between 35 and 60.',
  },
  {
    skillRange: [365, 370],
    recipeOrItem: '6x Drums of Battle',
    recipeSource: "Recipe sold by Almaador in Shattrath City; needs Honored with The Sha'tar.",
    keyMaterials: ['36 Heavy Knothide Leather', '24 Thick Clefthoof Leather'],
  },
  {
    skillRange: [370, 375],
    recipeOrItem: '6x Drums of Panic',
    recipeSource: 'Recipe sold by Alurmi, inside the Caverns of Time; needs Honored with Keepers of Time.',
    keyMaterials: ['36 Heavy Knothide Leather', '24 Fel Hide'],
    notes: 'Drums of Battle still work here without the Keepers of Time reputation, but they go green for the last three points, so it costs considerably more leather.',
  },
]
...
const tailoringLeveling: readonly RecipeLeveling[] = [
  ...
  {
    skillRange: [300, 325],
    recipeOrItem: '496x Bolt of Netherweave',
    recipeSource: 'Master Tailoring trainer (Outland).',
    keyMaterials: ['2,976 Netherweave Cloth'],
    notes: 'Every bolt is consumed by a later step, so making the full run now costs nothing but time.',
  },
  {
    skillRange: [325, 340],
    recipeOrItem: '102x Bolt of Imbued Netherweave',
    recipeSource: 'Pattern sold by Eiin in Shattrath City.',
    keyMaterials: ['306 Bolt of Netherweave', '204 Arcane Dust'],
    notes: 'Keep all 102 — they are the material for the tunics at 360.',
  },
  {
    skillRange: [340, 345],
    recipeOrItem: '5x Netherweave Boots',
    recipeSource: 'Taught by the trainer in Hellfire Peninsula, so it means a trip back.',
    keyMaterials: ['30 Bolt of Netherweave', '10 Knothide Leather', '5 Rune Thread'],
  },
  {
    skillRange: [345, 360],
    recipeOrItem: '20x Netherweave Tunic',
    recipeSource: 'Recipe sold by Eiin in Shattrath City.',
    keyMaterials: ['160 Bolt of Netherweave', '40 Rune Thread'],
    notes: 'Yellow for the last five points, so expect a few more than twenty.',
  },
  {
    skillRange: [360, 375],
    recipeOrItem: '17x Imbued Netherweave Tunic',
    recipeSource: 'Recipe sold by Arrond in Shadowmoon Valley.',
    keyMaterials: ['102 Bolt of Imbued Netherweave', '34 Netherweb Spider Silk', '17 Rune Thread'],
  },
]
