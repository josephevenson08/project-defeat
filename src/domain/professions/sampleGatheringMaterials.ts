...
const herbalismFarmSpots: readonly MaterialFarmSpot[] = [
  ...
  },
  {
    ...
    materials: ['Mageroyal', 'Briarthorn', 'Stranglekelp'],
    skillRange: [50, 125],
  ...
  },
  {
    ...
    materials: ['Bruiseweed', 'Wild Steelbloom', 'Kingsblood'],
    skillRange: [100, 175],
  ...
  },
  {
    ...
    materials: ['Liferoot', 'Fadeleaf', 'Goldthorn'],
    skillRange: [150, 210],
  ...
  },
  {
    ...
    materials: ["Khadgar's Whisker", 'Wintersbite', 'Sungrass'],
    skillRange: [185, 250],
  ...
  },
  {
    ...
    materials: ['Blindweed', 'Ghost Mushroom', 'Gromsblood'],
    skillRange: [230, 300],
  ...
  },
  {
    ...
    materials: ['Golden Sansam', 'Dreamfoil', 'Mountain Silversage'],
    skillRange: [230, 300],
  ...
  },
  {
    ...
    materials: ['Sorrowmoss', 'Icecap', 'Black Lotus'],
    skillRange: [260, 300],
...
const skinningFarmSpots: readonly MaterialFarmSpot[] = [
  ...
  },
  {
    ...
    materials: ['Thick Clefthoof Leather'],
    skillRange: [350, 375],
...
const fishingFarmSpots: readonly MaterialFarmSpot[] = [
  {
    ...
    materials: ['Raw Brilliant Smallfish', 'Raw Bristlefish'],
    skillRange: [1, 75],
  ...
  },
  {
    ...
    materials: ['Raw Loch Frenzy', 'Longjaw Mud Snapper'],
    skillRange: [75, 150],
  ...
  },
  {
    ...
    materials: ['Raw Bristle Whisker Catfish', 'Raw Brilliant Smallfish'],
    skillRange: [150, 225],
  ...
  },
  {
    ...
    materials: ['Raw Nightfin Snapper', 'Oily Blackmouth', 'Firefin Snapper'],
    skillRange: [225, 300],
  ...
  },
  {
    ...
    materials: ["Figluster's Mudfish", 'Icefin Bluefish'],
    skillRange: [325, 375],
