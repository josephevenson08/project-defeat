...
const guideUrl = 'https://www.wowhead.com/tbc/guide/classes/warlock/affliction/dps-bis-gear-pve-phase-2'
...
export const afflictionWarlockPhase2Bis: BisList = {
  id: 'affliction-warlock-phase-2-starter',
  className: 'Warlock',
  spec: 'Affliction',
  phase: 2,
  title: 'Affliction Warlock Phase 2 Starter Ranked List',
