...
export const enhancementShamanPhase2Bis: BisList = {
  ...
  entries: [
    ...
    { className: 'Shaman', spec: 'Enhancement', phase: 2, slot: 'Trinket 2', rank: 3, itemId: 'bloodlust-brooch', wowItemId: 29383, notes: 'Badge trinket fallback sample; compatible with either displayed trinket slot.', sourceName: 'Starter sample', sourceUrl: guideUrl },
