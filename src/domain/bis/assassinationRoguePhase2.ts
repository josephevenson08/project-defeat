...
export const assassinationRoguePhase2Bis: BisList = {
  id: 'assassination-rogue-phase-2-starter',
  className: 'Rogue',
  spec: 'Assassination',
  phase: 2,
  title: 'Assassination Rogue Phase 2 Starter Ranked List',
  ...
  entries: [
    entry({
      ...
      notes: 'Tier 5 Rogue set piece; shared by all three specs.',
    ...
    entry({
      ...
      notes: 'Shared physical DPS ring (also a Feral Druid pick).',
      sourceName: 'Starter sample',
