...
const guideUrl = 'https://www.wowhead.com/tbc/guide/classes/hunter/marksmanship/dps-bis-gear-pve-phase-2'
...
const sharedNote = 'Marksmanship shares almost the entire Phase 2 Hunter gear catalog with Beast Mastery/Survival (agility/AP/crit/hit is universally valuable); this list mirrors that shared catalog rather than a distinct itemization.'
...
export const marksmanshipHunterPhase2Bis: BisList = {
  id: 'marksmanship-hunter-phase-2-starter',
  className: 'Hunter',
  spec: 'Marksmanship',
  phase: 2,
  title: 'Marksmanship Hunter Phase 2 Starter Ranked List',
  ...
  entries: [
    entry({
      ...
      notes: `Tier 5 Hunter set piece. ${sharedNote}`,
    ...
    entry({
      ...
      notes: 'Shared physical DPS legs.',
      sourceName: 'Starter sample',
      source: source({ type: 'Raid', instance: 'Tempest Keep', boss: "Kael'thas Sunstrider", phase: 2, needsVerification: true }),
      needsVerification: true,
    }),
