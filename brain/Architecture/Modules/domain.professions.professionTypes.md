...
`src/domain/professions/professionTypes.ts` · **domain** layer · 81 lines

_No doc comment at the top of this file._

## Exports

**type** — `Profession`, `ProfessionCategory`, `ProfessionProfile`, `ProfessionTier`, `ProfessionTierName`, `RecipeLeveling`
