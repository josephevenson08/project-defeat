...
[[Tempest Keep - The Eye]] · encounter 4
...
- [[Tank]] — One tank kites the Phoenix in Phase 4; the advisor tanks must be pre-assigned by name for both Phase 1 and Phase 3.
- [[Physical DPS]] — Loot the Infinity Blade in Phase 2 — its on-hit dispel is what breaks the Phase 4 Mind Controls.
...
- **Destroyer Chestguard** (Tier Token) — [[Tank]]
  Warrior T5 tanking chest, redeemed from Chestguard of the Vanquished Defender.
- **Crystalforge Chestpiece** (Tier Token) — [[Physical DPS]]
  Paladin T5 chest, redeemed from Chestguard of the Vanquished Champion.
- **Crystalforge Breastplate** (Tier Token) — [[Healer]]
  Paladin T5 healing chest, redeemed from Chestguard of the Vanquished Champion.
- **Vestments of the Avatar** (Tier Token) — [[Healer]]
  Priest T5 chest, redeemed from Chestguard of the Vanquished Champion or Defender.
- **Nordrassil Chestpiece** (Tier Token) — [[Caster DPS]]
  Druid T5 chest, redeemed from Chestguard of the Vanquished Defender.
- **Nordrassil Chestguard** (Tier Token) — [[Healer]]
  Druid T5 healing chest, redeemed from Chestguard of the Vanquished Defender.
- **Rift Stalker Hauberk** (Tier Token) — [[Physical DPS]]
  Hunter T5 chest, redeemed from Chestguard of the Vanquished Hero.
- **Robes of Tirisfal** (Tier Token) — [[Caster DPS]]
  Mage T5 chest, redeemed from Chestguard of the Vanquished Hero.
- **Cataclysm Chestplate** (Tier Token) — [[Physical DPS]], [[Caster DPS]], [[Healer]]
