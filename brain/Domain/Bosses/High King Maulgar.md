...
- [[Tank]] — Maulgar goes back-to-wall so his 50% Charge cannot fling him into the raid.
- [[Caster DPS]] — A mage tanks Krosh Firehand and spell-steals his Blast Shield; a warlock banishes the Olm felhunters.
- [[Healer]] — Five separate tanks means five separate healing assignments — do not float.
...
- **Pauldrons of the Fallen Defender** (Tier Token) _(not in item catalog — [[Needs Verification]])_
  T4 shoulder token — Warrior, Priest, Druid.
- **Pauldrons of the Fallen Hero** (Tier Token) _(not in item catalog — [[Needs Verification]])_
  T4 shoulder token — Hunter, Mage, Rogue, Shaman.
- **Cyclone Shoulderguards** (Tier Token) — [[Physical DPS]]
  Shaman T4 shoulders, redeemed from Pauldrons of the Fallen Hero.
- **Justicar Shoulderguards** (Tier Token) — [[Tank]]
  Paladin T4 shoulders, redeemed from Pauldrons of the Fallen Champion.
- **Mantle of Malorne** (Tier Token) — [[Tank]], [[Physical DPS]]
