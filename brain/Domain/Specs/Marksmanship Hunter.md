...
**Steady Shot** — spell ID 34120, Ranged Special

- Cast: 1.5s · GCD 1.5s
- Scaling basis: attack power
- Attack power coefficient: 0.2
- Cost: 110 Mana
...
- **Phase 2** — 55 ranked entries across 15 slots · source: Marksmanship Hunter DPS Best in Slot (BiS) Phase 2 Gear Guide
