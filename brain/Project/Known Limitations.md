...
- Talents reach all 27 specs, but **coverage is not completeness**: 45 talent groups are refused by name, each with a reason. A talented estimate reads low, especially for casters.
