...
const PHASES = [
  ...
  },
  {
    ...
    status: 'partial',
    summary: 'Upgrade planning, side-by-side gear comparison, build save/load, import/export and source-and-cost planning all work. Shareable builds and a real mobile layout do not.',
    done: [
