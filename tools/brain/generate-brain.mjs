...
const PHASES = [
  ...
  },
  {
    ...
    status: 'partial',
    summary: 'Upgrade planning, side-by-side gear comparison, build save/load, import/export, source-and-cost planning and a phone layout that fits all work. Shareable builds do not, and fitting a phone is not the same as being designed for one.',
    done: [
